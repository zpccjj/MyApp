...
public class NewGZHJCheck {
	...
	private String JCX1;//阀座与塞座检查结果(1:合格;0:报废)
	private String JCX2;//内部检查结果(1:合格;0:报废)
	...
	private String AXHSKSSYBH;//4凹陷内划伤磕伤处剩余壁厚
	private String QXXMBH;//5缺陷修磨后壁厚
	private String JIANJU;//6底座支撑面与瓶底最低点之间距离
	private String FSCSYBH;//7腐蚀处剩余壁厚
	private String HFSYBH;//8焊缝热影响区剩余壁厚
	private String HFAXSD;//9焊缝热影响区凹陷深度
	private String CFSTJC;//10磁粉渗透检测合格级别
	private String SXJC;//11射线检测合格级别
	private String SFTSYBH;//12上封头剩余壁厚
	private String TTSYBH;//13筒体剩余壁厚
	private String XFTSYBH;//14下封头剩余壁厚
	private String SCRJ;//15实测容积
	private String GYBJRJ;//16钢印标记容积
	//检验操作人员
	private String C_WGJC;//外观检验员
	private String C_WGSH;//外观审核员
	private String C_FZSZJC;//阀座与塞座检验员
	private String C_FZSZSH;//阀座与塞座审核员
	...
	public String getAXHSKSSYBH() {
		return AXHSKSSYBH;
	}
	public void setAXHSKSSYBH(String aXHSKSSYBH) {
		AXHSKSSYBH = aXHSKSSYBH;
	}
	public String getQXXMBH() {
		return QXXMBH;
	}
	public void setQXXMBH(String qXXMBH) {
		QXXMBH = qXXMBH;
	}
	...
	public String getHFSYBH() {
		return HFSYBH;
	}
	public void setHFSYBH(String hFSYBH) {
		HFSYBH = hFSYBH;
	}
	...
	public String getSFTSYBH() {
		return SFTSYBH;
	}
	public void setSFTSYBH(String sFTSYBH) {
		SFTSYBH = sFTSYBH;
	}
	public String getTTSYBH() {
		return TTSYBH;
	}
	public void setTTSYBH(String tTSYBH) {
		TTSYBH = tTSYBH;
	}
	public String getXFTSYBH() {
		return XFTSYBH;
	}
	public void setXFTSYBH(String xFTSYBH) {
		XFTSYBH = xFTSYBH;
	}
	...
	public String getC_FZSZJC() {
		return C_FZSZJC;
	}
	public void setC_FZSZJC(String c_FZSZJC) {
		C_FZSZJC = c_FZSZJC;
	}
	public String getC_FZSZSH() {
		return C_FZSZSH;
	}
	public void setC_FZSZSH(String c_FZSZSH) {
		C_FZSZSH = c_FZSZSH;
	}
